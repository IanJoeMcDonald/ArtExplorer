...
Disafio do Jaya: https://github.com/jaya/art-explorer-ios/

---
## 📲 Implementation

UI desenvolvido utilzando UIKit.
Networking implementado utilizando Async/Await
Support para iOS 15+
Tests realizados com XCTest
Projeto "Modularizado" sem utilizar SPM/Cocoapods (para facilitar utilização):
Existe um pasta "External", tudo que esta dentro desse pasta, seria implementado em Modulos externos (Networking, Design System, Endpoints etc)

Demo:

![Simulador-PT](https://github.com/user-attachments/assets/3ac49f49-9421-44db-b545-d8e14c508a51)
...
2. **Favoritar Obras**
   ...
   * Persistência local (CoreData ou UserDefaults) ✅ (userDefaults)
